            ...
            <nav aria-label="breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/usuarios/create" class="link">Enviar convite de
                                usuário</a></li>
                    </ol>
                </nav>
            </nav>
...
@section('content')
    ...
    <makeuser-invite :polos='@json(\App\Http\Models\Polo::get())' :roles='@json($roles)'>
    </makeuser-invite>
@endsection
