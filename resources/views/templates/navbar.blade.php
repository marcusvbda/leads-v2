        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown {{ currentClass(['/admin/leads/*', '/admin/atendimento/*']) }}">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="{{ getMenuClass('viewlist-leads', ['/admin/leads/*']) }}" href="/admin/leads"
                        data-label="Base de Leads">Leads</a>
            ...
            <li class="nav-item dropdown {{ currentClass(['/admin/relatorios/*']) }}">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="{{ getMenuClass('viewlist-leads', ['/admin/relatorios/leads/*']) }}"
                        href="/admin/relatorios/leads" data-label="Relatório de Leads">Leads</a>
                </div>
            </li>
            ...
            <li
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="{{ getMenuClass('viewlist-contacttype', ['/admin/tipos-contato/*']) }}"
                        href="/admin/tipos-contato" data-label="Formar que o lead foi contato">Tipos de Contato</a>
                    <a class="{{ getMenuClass('viewlist-leadanswer', ['/admin/respostas-contato/*']) }}"
                        href="/admin/respostas-contato" data-label="Contatos com Lead">Respostas de Contato</a>
            ...
            <li class="nav-item dropdown {{ currentClass(['/admin/mensagens-wpp/*']) }}">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    @if(@$whatsapp_module->id)
                    <a class="dropdown-item {{ getMenuClass('viewlist-wppmessage',['/admin/mensagens-wpp/*']) }}"
