    ...
    <div>
        ...
        >
            <a @click.prevent="showPolosList" class="nav-link mt-0" href="#">
                <span
                    :class="[
                        'inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs dark:bg-gray-900',
                        'font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10 dark:text-neutral-200',
                    ]"
                >
                    {{ polo_name }}
                </span>
