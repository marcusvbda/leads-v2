<template>
    <div class="d-flex row align-items-center mr-1">
        <el-radio-group v-model="default_filter.selected_range" size="small">
            <el-radio-button v-if="Object.keys(date_ranges).includes('_this_year_')" label="_this_year_" border>Este Ano</el-radio-button>
            <el-radio-button v-if="Object.keys(date_ranges).includes('_this_month_')" label="_this_month_" border>Este Mês</el-radio-button>
            <el-radio-button v-if="Object.keys(date_ranges).includes('_this_week_')" label="_this_week_" border>Esta Semana</el-radio-button>
        ...
        <el-dialog title="Selecionar o polo" :visible.sync="dialog_polo_visible" width="50%">
            <el-select v-model="default_filter.polo_ids" filterable multiple placeholder="" class="w-100">
